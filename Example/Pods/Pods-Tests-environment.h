...
// JDFToolkit
#define COCOAPODS_POD_AVAILABLE_JDFToolkit
#define COCOAPODS_VERSION_MAJOR_JDFToolkit 0
#define COCOAPODS_VERSION_MINOR_JDFToolkit 1
#define COCOAPODS_VERSION_PATCH_JDFToolkit 0
